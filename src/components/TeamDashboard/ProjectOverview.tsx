...
export default function ProjectOverview({ project, onCompleteTask }: ProjectOverviewProps) {
  const todoTasks = project.totalTasks - project.completedTasks - project.inProgressTasks;
        ...
        <div className="flex items-center gap-2">
          ...
          {onCompleteTask && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-green-500 text-white text-xs font-medium hover:bg-green-600 active:scale-95 transition-all"
              aria-label="Mark a task as complete"
            >
