...
export default function ProgressChart({ project, weeklyData }: ProgressChartProps) {
  ...
  const completedStroke = (project.completedTasks / project.totalTasks) * circumference;
  const inProgressStroke = (project.inProgressTasks / project.totalTasks) * circumference;
          ...
          <div>
            ...
            <div className="h-1.5 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
              <div
                ...
                style={{ width: `${(project.overdueTasks / project.totalTasks) * 100}%` }}
              />
            </div>
          </div>
        </div>
